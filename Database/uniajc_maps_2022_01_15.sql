...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-01-2022 a las 15:34:37
...
(4, 'sTest', 's', NULL, 10),
(5, 'Prueba 2', 's', NULL, 9),
(6, 'sColombia', 's', NULL, 9),
(7, 'prueba 2021', 'desc', NULL, 9),
(8, 'prueba 2022', 'test', NULL, 9),
(9, 'kkkkkk', 'nnnn', NULL, 10),
(10, 'prueba 2222', 'desc', NULL, 9),
(11, 'mexico', 'mapa', NULL, 9),
(12, 'sk', 'dtess', NULL, 9),
(13, 's', 'sad', NULL, 9),
(14, 'prueba 3', 'desc', NULL, 9),
(15, 'mapa 3', 'kk', NULL, 9),
(16, 'long text', 'test', NULL, 9),
(17, 'prueba con la profe', 'test', NULL, 9),
(18, 'sad', 'testing', NULL, 9),
(19, 'testtest', 'testtest', './temp/2021-11-27_15-52-40//index.html', 9),
(20, 'TEST ALL', 'test', './temp/2021-11-27_16-28-49/index.html', 9);
...
--
-- Volcado de datos para la tabla `menu_capa_mapa`
--

INSERT INTO `menu_capa_mapa` (`menu_id`, `menu_capa_id`, `menu_mapa_id`) VALUES
(2, 1, 1),
(3, 6, 4),
(4, 7, 4),
(5, 8, 5),
...
(5, '123123', 'qwsa@dsa.com', 'prueba', '12vjy8B6VZQUU', 1, 8),
(6, '123', 'sdad@dsa.com', 'joseeeeee', '12IbR.gJ8wcpc', 1, 8),
(7, '33322', 'j@dsa.com', 'luis', '12FCJcNcrAhSE', 1, 8),
(8, 'j', 'j', 'j', '12BtqRyU8HrpU', 1, 7),
(9, 'j', 'j', 'j', '12BtqRyU8HrpU', 1, 7),
(10, 'j', 'd', 'j', '12BtqRyU8HrpU', 1, 7),
(11, 'k', 'k', 'k', '12ETMWicNpIZU', 1, 7),
(12, 'k', 'k', 'k', '12ETMWicNpIZU', 1, 8),
(13, 'ii', 'ii', 'ii', '12BfgCTRc9fPM', 1, 8),
(14, 'k', 'k', 'm', '12ETMWicNpIZU', 1, 8),
(15, '999999', '99@99.com', 'prueba 99', '122lD5TCwBq22', 1, 8),
(16, '112312312', 'unaijc@edsad.com', 'Cassas', '12FLHTs9hMBAo', 1, 8),
(17, '1233333', 'profe@dsad.commm', 'profe x2', '12IbR.gJ8wcpc', 2, 8);
...
--
ALTER TABLE `mapa`
  MODIFY `mapa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
